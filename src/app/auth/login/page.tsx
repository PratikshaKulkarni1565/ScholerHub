...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-gradient-to-br from-violet-50 via-indigo-50 to-blue-50">
      {/* Background blobs */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-violet-300/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      ...
      <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-violet-100/50 border border-white/60 p-8 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to your ScholarHub account</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/auth/register" className="text-violet-600 font-semibold hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );
